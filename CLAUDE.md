...
Ben Du's personal blogging system: a Python CLI that indexes/manages MyST Markdown & Jupyter Notebook posts and builds a static site with **Jupyter Book 2**, deployed to GitHub Pages (https://www.legendu.net). See `GEMINI.md` and https://deepwiki.com/legendu-net/blog for additional context.
