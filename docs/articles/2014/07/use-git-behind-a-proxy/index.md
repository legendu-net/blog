...
created: '2014-07-07T23:42:48-07:00'
...
1. The Git protocol is usually not supported in office.
   In this case,
...
1. If you come across the error of "SSL certificate problem: unable to get local issuer certificate",
