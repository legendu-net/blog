...
created: '2016-11-16T12:09:38-08:00'
date: '2026-06-12T22:15:55-07:00'
authors:
  - bendu
label: concurrency-and-parallel-computing-in-python
license: CC-BY-4.0
tags:
  - programming
  - Python
...
1. Multiprocessing has much higher overhead than multithreading.
...
1. You can use `os.cpu_count()` in Python to get the number of CPU cores on the machine.

1. If you are invoking shell commands from Python,
