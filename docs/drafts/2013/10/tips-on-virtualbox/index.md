...
created: '2013-10-03T10:42:46-07:00'
date: '2026-06-12T22:15:55-07:00'
authors:
  - bendu
label: tips-on-virtualbox
license: CC-BY-4.0
tags:
  - tips
  - VirtualBox
...
1. Check if you set a UUID for virtualbox, whether re-activation is still needed for MS word.
   Another thing is too see whether VM can access usb.

1. The activation has to do with the uuid change when creating the guest.
...
1. Word 2010 require reactivation on Virtualbox even if you COPY The entire virtual machine
   Word 2007 not sure, probably will work

1. If you install a backported linux image,
...
1. you probably need to restart after if you encounter problems in virtualbox and are required to install dkms to solve it ...
...
1. Set the scale of the virtual display to something other than "100% (unscaled output)".
...
1. To change the UUID of a Virtual Machine disk.
...
1. Better to make 32 bit virtual machines as it runs OK on both 32 and 64 bit computers.

1. Virtual machine is a good way to learn new technologies,
