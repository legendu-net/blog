...
created: '2016-12-10T10:12:31-08:00'
date: '2026-06-12T22:15:55-07:00'
authors:
  - bendu
label: tips-on-jupyterlab
license: CC-BY-4.0
tags:
  - software
  - JupyterLab
...
1. If you work across multiple machines,
...
1. If a notebook is running and outputing results,
...
1. Shutdown a kernel will kill the kernel associated with a notebook
...
1. hard to do interactive UI in JupyterLab right now ...
   many interactive UI pacakges in R relies on RStudio to work.

1. Convert Jupyter Notebook to another format.
...
1. If a JupyerLab notebook doesn't render well due to trust issues,
...
please refer to
[Get Information of Running Jupyter/Lab Servers](my-docker-images-get-information-of-running-jupyter-lab-servers)
.
...
- [Tips on IPython](ipython-is-the-best-shell)
...
## [JupyterLab Extenions](useful-tools-and-extensions-for-jupyterlab)
