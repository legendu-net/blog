...
1. Check Google map and get familiar about the route for road trips.

1. Download Google offline maps.

## Travel to US with B1/B2 Visa

Make sure to update [EVUS](https://www.evus.gov/evus/#/)
information within 72 hours before entering the US.
...
1. [Cabin Rentals & Glamping in the US | Postcard Cabins](https://share.google/uvAjjUBjqhbhu9hvr)

## Luggage for Flight

- IDs
  - quick pass if applicable (e.g.,
...
- Sleeping pillow
- CPAP (
  [Getting Through Airport Security With a CPAP](https://www.verywellhealth.com/airport-travel-with-cpap-3015056)
  ), Mask
- vitamins
- medicine (if any)
