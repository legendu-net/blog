...
1. [jpype.dbapi2](https://jpype.readthedocs.io/en/latest/dbapi2.html#)
...
1. PyAthenaJDBC is a JDBC package specifically for Amazon Athena.
...
1. There are lots of database specific packages relying on ODBC.
   For example,
...
1. [jreese/aiosqlite](https://github.com/jreese/aiosqlite)
...
1. pyodbc, pypyodbc: Python ODBC bridget.

1. SQLAlchemy

1. sqlalchemy-teradata
