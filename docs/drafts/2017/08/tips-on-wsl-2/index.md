---
title: Tips on WSL 2
created: '2017-08-26T23:23:44-07:00'
...
1. The opensource software Windows Terminal from software is the best terminal emulator for Windows.
...
1. You'd better use files names that work both in Windows and Linux,
   otherwise, weird behavior might happen.

1. Shift + Right Click -> "Open CMD here ..."

1. Starting with Win 10 Creator Update, Ubuntu 16.04 is available. if you installed old Ubuntu bash,
