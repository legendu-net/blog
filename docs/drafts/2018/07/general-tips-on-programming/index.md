...
created: '2018-07-20T00:25:59-07:00'
date: '2026-06-12T22:15:55-07:00'
authors:
  - bendu
label: general-tips-on-programming
license: CC-BY-4.0
tags:
  - programming
  - tips
...
1. Follow a good [Semantic Versioning](https://semver.org/)
   if you release your own library/software.

1. Keep a good habit to use parentheses
...
1. Always remember to check whether you have correct set/reset state of variables
...
1. Any initialization that might involve network, etc.
...
1. Warm up is important when profiling speed of applications.
...
1. Availability and stability are way more important than productivity and cool technology
...
[General Tips for Engineering](general-tips-on-programming)
