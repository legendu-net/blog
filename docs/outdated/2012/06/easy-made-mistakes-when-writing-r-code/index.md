...
created: '2012-06-14T22:04:09-07:00'
date: '2026-08-11T22:19:36-07:00'
authors:
  - bendu
label: easy-made-mistakes-when-writing-r-code
license: CC-BY-4.0
tags:
  - vector
  - operator
...
<img src="/media/r/mistake.jpg" height="200" width="240" align="right"/>
...
1. Use vectors or missing value as conditions\
   For if and while statement, the condition must be a non-missing
   scaler (a vector of length 1).

1. Use `*apply` functions to operate on rows of data frames.
