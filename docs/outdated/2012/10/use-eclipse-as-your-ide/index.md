...
created: '2012-10-22T13:41:22-07:00'
date: '2026-06-12T22:15:55-07:00'
authors:
  - bendu
label: use-eclipse-as-your-ide
license: CC-BY-4.0
tags:
  - IDE
  - programming
...
1. To quickly comment selected code in Eclipse,
   you can use hot keys `Crtl+/`.
   To uncomment selected code,
   simply press the hot keys again.

1. To quickly import a package which has no `.jar` files
...
1. To change a variable name, you'd better use refactor which will
   automatically change all occurrences.

1. Use `TODO` to add task in eclipse.

1. To build projects manually,
   follow instructions
...
1. To change editor fonts in Eclipse.
