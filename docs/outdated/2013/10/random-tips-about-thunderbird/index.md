...
created: '2013-10-04T14:29:35-07:00'
date: '2026-08-11T22:39:38-07:00'
authors:
  - bendu
label: random-tips-about-thunderbird
license: CC-BY-4.0
tags:
  - tips
  - software
...
1. External Editor Plugin

1. not good way to use thunderbird as RSS reader,
   too big very soon,
   cannot sync, just use a web RSS, e.g., feedly

1. archive your important emails!!!

1. Do not use display attachment inline.
...
1. To show pictures in the email:
   Menu: Edit -> Preference -> Privacy -> Allow remote content in messages

1. to disable message sync (can be useful if you want to keep an expired email account but don't want to get bother by login failure message)
...
1. It seems more and more to me that sync thunderbird is not a good idea ...
   At least, you should not use btsync because it causes problems frequently ...

1. You should think about how to sync address book,
...
1. You can move an old `msgFilterRules.dat` file
...
1. right click on the acount and choose settings
1. click Account Action at the bottom and then choose Set as Default in the drop-down menu.

## Questions

1. thunderbird: is there an easy way to convert a message filter on one account to another account?

1. thunderbird hangs at "attaching ..." -> reply contains image that are not available or after compact folders ...
